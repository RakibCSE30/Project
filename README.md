...
To know details about Academia application click [here] (https://github.com/RakibCSE30/Project/wiki/Meeting-of-Minutes-1-(Coding-Standards-&-Documentation-Tools)).
## Features
* Feature 1
* Feature 2
